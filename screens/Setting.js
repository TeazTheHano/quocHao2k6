                                ...
                                <View style={[styles.flexRow, styles.flexWrap, styles.justifyContentSpaceBetween]}>
                                    <View style={[styles.flexCol, styles.alignItemsCenter, { width: '49%', backgroundColor: colorStyle.blue1, padding: vw(5), borderRadius: vw(4), marginBottom: vw(2) }]}>
                                        ...
                                        <View style={[styles.flexRow, styles.gap4vw, styles.alignItemsCenter]}>
                                            ...
                                            <Text style={[componentStyle.Os32Bold, { color: colorStyle.tan1 }]}>{currentUser.jobAttempt.length}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={[styles.flexCol, styles.alignItemsCenter, { width: '49%', backgroundColor: colorStyle.blue1, padding: vw(5), borderRadius: vw(4), marginBottom: vw(2) }]}>
                                        ...
                                        <View style={[styles.flexRow, styles.gap4vw, styles.alignItemsCenter]}>
                                            ...
                                            <Text style={[componentStyle.Os32Bold, { color: colorStyle.tan1 }]}>{currentUser.jobSave.length}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={[styles.flexCol, styles.alignItemsCenter, { width: '49%', backgroundColor: colorStyle.blue1, padding: vw(5), borderRadius: vw(4), marginBottom: vw(2) }]}>
                                        ...
                                        <View style={[styles.flexRow, styles.gap4vw, styles.alignItemsCenter]}>
                                            ...
                                            <Text style={[componentStyle.Os32Bold, { color: colorStyle.tan1 }]}>{currentUser.followCompany.length}</Text>
                                        </View>
                                    </View>
